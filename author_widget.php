 ...
 * Description: WordPress Author Plugin Widget has a simple user interface to display author information in the sidebar. All you have to do is drag the WordPress Author Plugin Widget into the sidebar and the plugin will do the needful.  For further information or if you have any questions/installation please do not hesitate to contact us on our website: <a href="http://themefantasy.com/plugin/wordpress-author-plugin-widget/" target="_blank">Click here</a> Step 1: Go to Widget:-> Find "Author Avatar List" -> Drag and drop wherever you want to display and fill the value. Here is the link for tutorial <a href="https://s.w.org/plugins/author-profiles/screenshot-2.png" target="_blank"> link </a>
